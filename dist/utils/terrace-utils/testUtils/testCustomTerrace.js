...
const testCustomTerrace = {
    ...
    food_category: ["Mediterranean", "Spanish", "Tapas"],
    placement_type: ["Outdoor", "Indoor"],
    emotional_tags: ["Relaxed", "Cozy", "FamilyFriendly"],
    cover_type: ["Umbrella", "FullCover"],
    dietary_restrictions: ["Vegan", "GlutenFree"],
    profile_pic: "terrace1.jpg",
    opening_hours: defaultOpeningHours,
};
//# sourceMappingURL=testCustomTerrace.js.map